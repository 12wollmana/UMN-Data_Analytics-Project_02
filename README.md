...
<ol>
  <li>
    This project is a <strong>dashboard</strong> analyzing the Minneapolis Police Department's use of force over the past 12 years. The <strong>Police Use Force Dataset</strong> is retrieved from opendataminneapolis
  </li>
  <li>
